...
- GSE193677 is included as an independent adult activity/phenotype support cohort. Its count matrix is processed separately from treatment-endpoint cohorts, and its activity/phenotype associations are not pooled with healing or response outcomes.
