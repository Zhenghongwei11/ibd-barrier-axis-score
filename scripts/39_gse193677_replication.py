...
def main() -> int:
    ...
    full_axis_mean = float(joined["axis_score"].mean())
    full_axis_sd = float(joined["axis_score"].std(ddof=1))
    ...
    one["axis_score_z"] = (one["axis_score"] - full_axis_mean) / full_axis_sd
    ...
    all_["axis_score_z"] = (all_["axis_score"] - full_axis_mean) / full_axis_sd
